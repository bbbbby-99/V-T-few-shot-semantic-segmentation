...
def turn_off(model):
    optim_or_not(model.conv1, True)
    optim_or_not(model.layer1, True)
    optim_or_not(model.layer2, True)
    optim_or_not(model.layer3, True)
    optim_or_not(model.conv1_th, True)
    optim_or_not(model.layer1_th, True)
    optim_or_not(model.layer2_th, True)
    optim_or_not(model.layer3_th, True)
...
def get_10x_lr_params(model):
    ...
    b = []
    b.append(model.FMM_s3.parameters())
    b.append(model.FMM_q3.parameters())
    b.append(model.layer5.parameters())
    b.append(model.layer5_th.parameters())
